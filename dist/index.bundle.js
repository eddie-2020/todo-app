...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles.css */ \"./src/styles.css\");\n/* harmony import */ var _storage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./storage */ \"./src/storage.js\");\n/* harmony import */ var _functional__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./functional */ \"./src/functional.js\");\n\r\n\r\n\r\n\r\n// Array Of Event Tasks To Do\r\nconst eventList = [\r\n  {\r\n    description: 'Play video games',\r\n    completed: false,\r\n    index: 0,\r\n  },\r\n  {\r\n    description: 'Go Shopping',\r\n    completed: true,\r\n    index: 1,\r\n  },\r\n  {\r\n    description: 'Cook Dinner',\r\n    completed: false,\r\n    index: 2,\r\n  },\r\n  {\r\n    description: 'Listen to music',\r\n    completed: true,\r\n    index: 3,\r\n  },\r\n  {\r\n    description: 'Read Novels',\r\n    completed: false,\r\n    index: 4,\r\n  },\r\n];\r\n\r\n// Add Events To List\r\nconst addToEvent = () => {\r\n  if ((0,_functional__WEBPACK_IMPORTED_MODULE_2__.getEventFromLocalStorage)() === null) {\r\n    (0,_functional__WEBPACK_IMPORTED_MODULE_2__.setEventToLocalStorage)(eventList);\r\n  } else {\r\n    const sortedEventList = (0,_functional__WEBPACK_IMPORTED_MODULE_2__.getEventFromLocalStorage)().sort((a, b) => a.index - b.index);\r\n    sortedEventList.sort((x, y) => x.index - y.index);\r\n    for (let i = 0; i < sortedEventList.length; i += 1) {\r\n      if (sortedEventList[i].completed === true) {\r\n        (0,_storage__WEBPACK_IMPORTED_MODULE_1__.checkEvent)(sortedEventList[i].index, true);\r\n      } else {\r\n        (0,_storage__WEBPACK_IMPORTED_MODULE_1__.checkEvent)(sortedEventList[i].index, false);\r\n      }\r\n      // create list item\r\n      const listEventItems = document.querySelector('.eventList');\r\n      listEventItems.insertAdjacentHTML(\r\n        'beforeend',\r\n        `\r\n          <div class=\"eventTask\">\r\n            <div class=\"eventChecks\">\r\n              <input type=\"checkbox\" name=\"item-${sortedEventList[i].index\r\n}\" class=\"checkbox\" ${sortedEventList[i].completed ? 'checked' : ''}>\r\n              <span class=\"eventCheckmark\" ${sortedEventList[i].completed\r\n    ? 'style=\"text-decoration: line-through\"'\r\n    : ''\r\n}>${sortedEventList[i].description}</span>\r\n            </div>\r\n            <div class=\"material-icons-outlined\">more_vert</div>\r\n          </div>\r\n        `,\r\n      );\r\n      (0,_storage__WEBPACK_IMPORTED_MODULE_1__.checkEvent)();\r\n    }\r\n  }\r\n};\r\n\r\nwindow.onload = () => {\r\n  (0,_storage__WEBPACK_IMPORTED_MODULE_1__.currentChecks)(eventList);\r\n  addToEvent();\r\n  (0,_functional__WEBPACK_IMPORTED_MODULE_2__.getEventFromLocalStorage)(eventList);\r\n  (0,_functional__WEBPACK_IMPORTED_MODULE_2__.setEventToLocalStorage)(eventList);\r\n};\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({ addToEvent });\r\n\n\n//# sourceURL=webpack://webpack-setup/./src/index.js?");
